...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.taotao.com/"><img clstag="clickcart|keycount|xincart|logo" src="/images/taotao-logo.gif" title="返回买宝商城首页" alt="返回买宝商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">买宝价</div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去买宝国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去买宝结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">

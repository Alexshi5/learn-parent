...
<!--shortcut end-->
	...
	<div class="w w1 header clearfix">
		<div id="logo"><a href="http://www.taotao.com/"><img src="/images/taotao-logo.gif"  alt="买宝商城" /></a></div>
	...
	<div class="s-content payment-info">
        ...
        <div class="way-list">
	        			        				         <div class="way-item">
			            买宝快递&nbsp;&nbsp;中小件商品&nbsp;&nbsp;<font color='#FF6600;'>工作日、双休日与假日均可送货</font> &nbsp;
		...
		<div class="invoice-content">
				...
				<div class="ftx-04 invoice-prompt">
                    <dl class="clearfix">
                       <dt>温馨提示：</dt>
                       <dd>
                           <div>发票的开票金额不包括买宝卡/买宝E卡、优惠券和京豆支付部分</div>
						...
						<div id="checkout-floatbar" class="checkout-buttons group">
							<div class="inner">
								...
								<div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
									部分商品货到付款方式：先由买宝配送“提货单”并收款，然后厂商发货。
								</div>
							</div>
...
<div class="bt bt-w freight-tooltip hide" id="transport">
   ...
   <div class="w">
	...
	$('#bill-tip-btn').Jtips({//随点随帮tip弹出
		"content":'<a target="_blank" href="http://help.jd.com/help/question-61.html#kjfpf">如何区分买宝销售和第三方卖家销售的商品?</a>',
		"close":true,			
	    "position": 'bottom'
	});
	//<![CDATA[

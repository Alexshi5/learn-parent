...
<div class="w" id="logo">
    <div>
    	<a href="http://www.taotao.com/">
    		<img src="/images/taotao-logo.gif" alt="买宝商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div id="o-password">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《买宝用户注册协议》</a></label>
                        <span class="clr"></span>

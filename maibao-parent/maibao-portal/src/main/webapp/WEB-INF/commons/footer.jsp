	...
	<div id="service-2013">
		...
		<dl class="fore5">
			...
			<dd>		
				...
				<div><a href="http://giftcard.jd.com/market/index.action" target="_blank" rel="nofollow">买宝E卡</a></div>
				<div><a href="http://help.jd.com/help/question-91.html" target="_blank" rel="nofollow">节能补贴</a></div>
				<div><a href="http://mobile.jd.com/" target="_blank" rel="nofollow">买宝通信</a></div>
			</dd>
		</dl>
		<div class="fr">
			<div class="sm" id="branch-office">
				...
				<div class="smc">
					<p>买宝已向全国1859个区县提供自营配送服务，支持货到付款、POS机刷卡和售后上门服务。</p>

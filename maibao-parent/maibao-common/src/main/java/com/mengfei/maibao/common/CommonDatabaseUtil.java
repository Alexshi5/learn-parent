...
public class CommonDatabaseUtil {
    ...
    public static void main(String[] args) throws Exception {
        //测试备份（windows和linux环境下均可）
        /*String command1 = "mysqldump -hlocalhost -ualex -p123 demo";//参数依次是IP、账号、密码、数据库名
        String savePath1 = "D:/demo.sql";
        boolean b1 = new CommonDatabaseUtil().util(command1, savePath1);
        if(b1){

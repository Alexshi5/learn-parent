package com.mengfei.test.fbsep.config;
...
public class ExceptionAspect {
    ...
    public ApiResponse handleHttpMessageNotReadableException(
        ...
        return new ApiResponse(HttpStatus.BAD_REQUEST.value(),"could_not_read_json...");
    }
    ...
    public ApiResponse handleValidationException(MethodArgumentNotValidException e) {
        ...
        return new ApiResponse(HttpStatus.BAD_REQUEST.value(),errorInformation.toString());
    }
    ...
    public ApiResponse handleTokenException(Exception e) {
        log.error("Token is invaild...", e);
        return new ApiResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(),"Token is invaild...");
    }*/
